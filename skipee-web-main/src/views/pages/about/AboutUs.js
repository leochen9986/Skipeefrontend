    ...
    <div className="bg-white">
      ...
      <div className="py-5" style={{ backgroundColor: '#E9EDF2' }}>
        <CContainer>
          <CRow>
            <CCol xs="12" md="6">
              <img src="/assets/about_2.png" alt="about" width="100%" />
            </CCol>
            <CCol
              xs="12"
              md="6"
            ...
            >
              <h2 className="fw-bold mb-3 mt-5">Intuitive. Comprehensive. Efficient.</h2>
        ...
        <CContainer>
          <CRow>
            ...
            >
              ...
              <p className="text-center">
                Experience the freedom of No minimum contract length, No cancellation fees, and No
                setup costs. Instead benefit from a revenue share on every queue skip sold, with x%
